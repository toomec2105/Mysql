...
CREATE TABLE Games(
    ...
    */
      ...
      INSERT INTO Games(gameName,category,studio,photo,learningCurve,releaseYear,supported,microtransactions,playerID)
      VALUES('Leauge of Legends', 'MOBA', 'Riot Games Studio', LOAD_FILE('~/dbs/games/lollogo.jpeg'), 'medium', 2009, true, true,5);
      
 INSERT INTO Games(gameName,category,studio, price,learningCurve,releaseYear,supported,microtransactions,playerID)
      ...
      INSERT INTO Games(gameName,category,studio,learningCurve,releaseYear,supported,microtransactions,playerID)
